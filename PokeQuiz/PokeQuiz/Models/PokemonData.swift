...
struct Pokemon: Hashable, Codable {
    ...
    static var allPokemon = [
        ...
        Pokemon(name: "Alolan Rattata", number: "019_alola", type: ["Dark", "Normal"], region: "Alola"),
        Pokemon(name: "Alolan Raticate", number: "020_alola", type: ["Dark", "Normal"], region: "Alola"),
        Pokemon(name: "Alolan Raichu", number: "026_alola", type: ["Electric", "Psychic"], region: "Alola"),
        Pokemon(name: "Alolan Sandshrew", number: "027_alola", type: ["Ice", "Steel"], region: "Alola"),
        Pokemon(name: "Alolan Sandslash", number: "028_alola", type: ["Ice", "Steel"], region: "Alola"),
        Pokemon(name: "Alolan Vulpix", number: "037_alola", type: ["Ice"], region: "Alola"),
        Pokemon(name: "Alolan Ninetails", number: "038_alola", type: ["Ice", "Fairy"], region: "Alola"),
        Pokemon(name: "Alolan Diglet", number: "050_alola", type: ["Ground", "Steel"], region: "Alola"),
        Pokemon(name: "Alolan Dugtrio", number: "051_alola", type: ["Ground", "Steel"], region: "Alola"),
        Pokemon(name: "Alolan Meowth", number: "052_alola", type: ["Dark"], region: "Alola"),
        Pokemon(name: "Alolan Persian", number: "053_alola", type: ["Dark"], region: "Alola"),
        Pokemon(name: "Alolan Geodude", number: "074_alola", type: ["Rock", "Electric"], region: "Alola"),
        Pokemon(name: "Alolan Graveler", number: "075_alola", type: ["Rock", "Electric"], region: "Alola"),
        Pokemon(name: "Alolan Golem", number: "076_alola", type: ["Rock", "Electric"], region: "Alola"),
        Pokemon(name: "Alolan Grimer", number: "088_alola", type: ["Poison", "Dark"], region: "Alola"),
        Pokemon(name: "Alolan Muk", number: "089_alola", type: ["Poison", "Dark"], region: "Alola"),
        Pokemon(name: "Alolan Exeggutor", number: "103_alola", type: ["Grass", "Dragon"], region: "Alola"),
        Pokemon(name: "Alolan Marowak", number: "105_alola", type: ["Fire", "Ghost"], region: "Alola"),
        Pokemon(name: "Grookey", number: "810", type: ["Grass"], region: "Galar"),
        Pokemon(name: "Thwackey", number: "811", type: ["Grass"], region: "Galar"),
        Pokemon(name: "Rillaboom", number: "812", type: ["Grass"], region: "Galar"),
        Pokemon(name: "Scorbunny", number: "813", type: ["Fire"], region: "Galar"),
        Pokemon(name: "Raboot", number: "814", type: ["Fire"], region: "Galar"),
        Pokemon(name: "Cinderace", number: "815", type: ["Fire"], region: "Galar"),
        Pokemon(name: "Sobble", number: "816", type: ["Water"], region: "Galar"),
        Pokemon(name: "Drizzile", number: "817", type: ["Water"], region: "Galar"),
        Pokemon(name: "Inteleon", number: "818", type: ["Water"], region: "Galar"),
        Pokemon(name: "Skwovet", number: "819", type: ["Normal"], region: "Galar"),
        Pokemon(name: "Greedent", number: "820", type: ["Normal"], region: "Galar"),
        Pokemon(name: "Rookidee", number: "821", type: ["Flying"], region: "Galar"),
        Pokemon(name: "Corvisquire", number: "822", type: ["Flying"], region: "Galar"),
        Pokemon(name: "Corviknight", number: "823", type: ["Flying", "Steel"], region: "Galar"),
        Pokemon(name: "Blipbug", number: "824", type: ["Bug"], region: "Galar"),
        Pokemon(name: "Dottler", number: "825", type: ["Bug", "Psychic"], region: "Galar"),
        Pokemon(name: "Orbeetle", number: "826", type: ["Bug", "Psychic"], region: "Galar"),
        Pokemon(name: "Nickit", number: "827", type: ["Dark"], region: "Galar"),
        Pokemon(name: "Thievul", number: "828", type: ["Dark"], region: "Galar"),
        Pokemon(name: "Gossifleur", number: "829", type: ["Grass"], region: "Galar"),
        Pokemon(name: "Eldegoss", number: "830", type: ["Grass"], region: "Galar"),
        Pokemon(name: "Wooloo", number: "831", type: ["Normal"], region: "Galar"),
        Pokemon(name: "Dubwool", number: "832", type: ["Normal"], region: "Galar"),
        Pokemon(name: "Chewtle", number: "833", type: ["Water"], region: "Galar"),
        Pokemon(name: "Drednaw", number: "834", type: ["Water", "Rock"], region: "Galar"),
        Pokemon(name: "Yamper", number: "835", type: ["Electric"], region: "Galar"),
        Pokemon(name: "Boltund", number: "836", type: ["Electric"], region: "Galar"),
        Pokemon(name: "Rolycoly", number: "837", type: ["Rock"], region: "Galar"),
        Pokemon(name: "Carkol", number: "838", type: ["Rock", "Fire"], region: "Galar"),
        Pokemon(name: "Coalossal", number: "839", type: ["Rock", "Fire"], region: "Galar"),
        Pokemon(name: "Applin", number: "840", type: ["Grass", "Dragon"], region: "Galar"),
        Pokemon(name: "Flapple", number: "841", type: ["Grass", "Dragon"], region: "Galar"),
        Pokemon(name: "Appletun", number: "842", type: ["Grass", "Dragon"], region: "Galar"),
        Pokemon(name: "Silicobra", number: "843", type: ["Ground"], region: "Galar"),
        Pokemon(name: "Sandaconda", number: "844", type: ["Ground"], region: "Galar"),
        Pokemon(name: "Cramorant", number: "845", type: ["Flying", "Water"], region: "Galar"),
        Pokemon(name: "Arrokuda", number: "846", type: ["Water"], region: "Galar"),
        Pokemon(name: "Barraskewda", number: "847", type: ["Water"], region: "Galar"),
        Pokemon(name: "Toxel", number: "848", type: ["Electric", "Poison"], region: "Galar"),
        Pokemon(name: "Toxtricity", number: "849", type: ["Electric", "Poison"], region: "Galar"),
        Pokemon(name: "Sizzlipede", number: "850", type: ["Fire", "Bug"], region: "Galar"),
        Pokemon(name: "Centiskorch", number: "851", type: ["Fire", "Bug"], region: "Galar"),
        Pokemon(name: "Clobbopus", number: "852", type: ["Fighting"], region: "Galar"),
        Pokemon(name: "Grapploct", number: "853", type: ["Fighting"], region: "Galar"),
        Pokemon(name: "Sinistea", number: "854", type: ["Ghost"], region: "Galar"),
        Pokemon(name: "Polteageist", number: "855", type: ["Ghost"], region: "Galar"),
        Pokemon(name: "Hatenna", number: "856", type: ["Psychic"], region: "Galar"),
        Pokemon(name: "Hattrem", number: "857", type: ["Psychic"], region: "Galar"),
        Pokemon(name: "Hatterene", number: "858", type: ["Psychic", "Fairy"], region: "Galar"),
        Pokemon(name: "Impidimp", number: "859", type: ["Dark", "Fairy"], region: "Galar"),
        Pokemon(name: "Morgrem", number: "860", type: ["Dark", "Fairy"], region: "Galar"),
        Pokemon(name: "Grimmsnarl", number: "861", type: ["Dark", "Fairy"], region: "Galar"),
        Pokemon(name: "Obstagoon", number: "862", type: ["Dark", "Normal"], region: "Galar"),
        Pokemon(name: "Perrserker", number: "863", type: ["Steel"], region: "Galar"),
        Pokemon(name: "Cursola", number: "864", type: ["Ghost"], region: "Galar"),
        Pokemon(name: "Sirfetch'd", number: "865", type: ["Fighting"], region: "Galar"),
        Pokemon(name: "Mr. Rime", number: "866", type: ["Ice", "Psychic"], region: "Galar"),
        Pokemon(name: "Runerigus", number: "867", type: ["Ground", "Ghost"], region: "Galar"),
        Pokemon(name: "Milcery", number: "868", type: ["Fairy"], region: "Galar"),
        Pokemon(name: "Alcremie", number: "869", type: ["Fairy"], region: "Galar"),
        Pokemon(name: "Falinks", number: "870", type: ["Fighting"], region: "Galar"),
        Pokemon(name: "Pincurchin", number: "871", type: ["Electric"], region: "Galar"),
        Pokemon(name: "Snom", number: "872", type: ["Ice", "Bug"], region: "Galar"),
        Pokemon(name: "Frosmoth", number: "873", type: ["Ice", "Bug"], region: "Galar"),
        Pokemon(name: "Stonjourner", number: "874", type: ["Rock"], region: "Galar"),
        Pokemon(name: "Eiscue", number: "875", type: ["Ice"], region: "Galar"),
        Pokemon(name: "Indeedee", number: "876", type: ["Psychic", "Normal"], region: "Galar"),
        Pokemon(name: "Morpeko", number: "877", type: ["Electric", "Dark"], region: "Galar"),
        Pokemon(name: "Cufant", number: "878", type: ["Steel"], region: "Galar"),
        Pokemon(name: "Copperajah", number: "879", type: ["Steel"], region: "Galar"),
        Pokemon(name: "Dracozolt", number: "880", type: ["Electric", "Dragon"], region: "Galar"),
        Pokemon(name: "Arctozolt", number: "881", type: ["Electric", "Ice"], region: "Galar"),
        Pokemon(name: "Dracovish", number: "882", type: ["Water", "Dragon"], region: "Galar"),
        Pokemon(name: "Arctovish", number: "883", type: ["Water", "Ice"], region: "Galar"),
        Pokemon(name: "Duraludon", number: "884", type: ["Steel", "Dragon"], region: "Galar"),
        Pokemon(name: "Dreepy", number: "885", type: ["Dragon", "Ghost"], region: "Galar"),
        Pokemon(name: "Drakloak", number: "886", type: ["Dragon", "Ghost"], region: "Galar"),
        Pokemon(name: "Dragapult", number: "887", type: ["Dragon", "Ghost"], region: "Galar"),
        Pokemon(name: "Zacian", number: "888", type: ["Fairy"], region: "Galar"),
        Pokemon(name: "Zacian (Crowned Sword)", number: "888_sword", type: ["Fairy", "Steel"], region: "Galar"),
        Pokemon(name: "Zamazenta", number: "889", type: ["Fighting"], region: "Galar"),
        Pokemon(name: "Zamazenta (Crowned Shield)", number: "889_shield", type: ["Fighting", "Steel"], region: "Galar"),
        Pokemon(name: "Eternatus", number: "890", type: ["Poison", "Dragon"], region: "Galar"),
        Pokemon(name: "Kubfu", number: "891", type: ["Fighting"], region: "Galar"),
        Pokemon(name: "Urshifu (Single Strike)", number: "892", type: ["Fighting", "Dark"], region: "Galar"),
        Pokemon(name: "Urshifu (Rapid Strike)", number: "892_rapidStrike", type: ["Fighting", "Water"], region: "Galar"),
        Pokemon(name: "Zarude", number: "893", type: ["Dark", "Grass"], region: "Galar"),
        Pokemon(name: "Regieleki", number: "894", type: ["Electric"], region: "Galar"),
        Pokemon(name: "Regidrago", number: "895", type: ["Dragon"], region: "Galar"),
        Pokemon(name: "Glastrier", number: "896", type: ["Ice"], region: "Galar"),
        Pokemon(name: "Spectrier", number: "897", type: ["Ghost"], region: "Galar"),
        Pokemon(name: "Calyrex", number: "898", type: ["Psychic", "Grass"], region: "Galar"),
        Pokemon(name: "Galarian Meowth", number: "052_galar", type: ["Steel"], region: "Galar"),
        Pokemon(name: "Galarian Ponyta", number: "077_galar", type: ["Psychic"], region: "Galar"),
        Pokemon(name: "Galarian Rapidash", number: "078_galar", type: ["Psychic", "Fairy"], region: "Galar"),
        Pokemon(name: "Galarian Slowpoke", number: "079_galar", type: ["Psychic"], region: "Galar"),
        Pokemon(name: "Galarian Slowbro", number: "080_galar", type: ["Poison", "Psychic"], region: "Galar"),
        Pokemon(name: "Galarian Farfetch’d", number: "083_galar", type: ["Fighting"], region: "Galar"),
        Pokemon(name: "Galarian Weezing", number: "110_galar", type: ["Poison", "Fairy"], region: "Galar"),
        Pokemon(name: "Galarian Mr. Mime", number: "122_galar", type: ["Ice", "Psychic"], region: "Galar"),
        Pokemon(name: "Galarian Corsola", number: "222_galar", type: ["Ghost"], region: "Galar"),
        Pokemon(name: "Galarian Zigzagoon", number: "263_galar", type: ["Dark", "Normal"], region: "Galar"),
        Pokemon(name: "Galarian Linoone", number: "264_galar", type: ["Dark", "Normal"], region: "Galar"),
        Pokemon(name: "Galarian Linoone", number: "264_galar", type: ["Dark", "Normal"], region: "Galar"),
        Pokemon(name: "Galarian Darumaka", number: "554_galar", type: ["Ice"], region: "Galar"),
        Pokemon(name: "Galarian Darmanitan", number: "555_galar", type: ["Ice"], region: "Galar"),
        Pokemon(name: "Galarian Yamask", number: "562_galar", type: ["Ground", "Ghost"], region: "Galar"),
        Pokemon(name: "Galarian Stunfisk", number: "618_galar", type: ["Ground", "Steel"], region: "Galar"),
        Pokemon(name: "Galarian Slowking", number: "199_galar", type: ["Poison", "Psychic"], region: "Galar"),
        Pokemon(name: "Galarian Arcticuno", number: "144_galar", type: ["Psychic", "Flying"], region: "Galar"),
        Pokemon(name: "Galarian Zapdos", number: "145_galar", type: ["Fighting", "Flying"], region: "Galar"),
        Pokemon(name: "Galarian Moltres", number: "146_galar", type: ["Dark", "Flying"], region: "Galar"),
        Pokemon(name: "Hisuian Growlithe", number: "058_hisui", type: ["Fire", "Rock"], region: "Hisui"),
        Pokemon(name: "Hisuian Arcanine", number: "059_hisui", type: ["Fire", "Rock"], region: "Hisui"),
        Pokemon(name: "Hisuian Voltorb", number: "100_hisui", type: ["Electric", "Grass"], region: "Hisui"),
        Pokemon(name: "Hisuian Electrode", number: "101_hisui", type: ["Electric", "Grass"], region: "Hisui"),
        Pokemon(name: "Hisuian Typhlosion", number: "157_hisui", type: ["Fire", "Ghost"], region: "Hisui"),
        Pokemon(name: "Hisuian Qwilfish", number: "211_hisui", type: ["Dark", "Poison"], region: "Hisui"),
        Pokemon(name: "Overqwil", number: "overqwil", type: ["Dark", "Poison"], region: "Hisui"),
        Pokemon(name: "Hisuian Sneasel", number: "215_hisui", type: ["Fighting", "Poison"], region: "Hisui"),
        Pokemon(name: "Sneasler", number: "sneasler", type: ["Fighting", "Poison"], region: "Hisui"),
        Pokemon(name: "Hisuian Samurott", number: "503_hisui", type: ["Water", "Dark"], region: "Hisui"),
        Pokemon(name: "Hisuian Lilligant", number: "549_hisui", type: ["Grass", "Fighting"], region: "Hisui"),
        Pokemon(name: "Hisuian Zorua", number: "570_hisui", type: ["Normal", "Ghost"], region: "Hisui"),
        Pokemon(name: "Hisuian Zoroark", number: "571_hisui", type: ["Normal", "Ghost"], region: "Hisui"),
        Pokemon(name: "Hisuian Braviary", number: "628_hisui", type: ["Psychic", "Flying"], region: "Hisui"),
        Pokemon(name: "Hisuian Sliggoo", number: "705_hisui", type: ["Steel", "Dragon"], region: "Hisui"),
        Pokemon(name: "Hisuian Goodra", number: "706_hisui", type: ["Steel", "Dragon"], region: "Hisui"),
        Pokemon(name: "Hisuian Avalugg", number: "713_hisui", type: ["Ice", "Rock"], region: "Hisui"),
        Pokemon(name: "Hisuian Decidueye", number: "724_hisui", type: ["Grass", "Fighting"], region: "Hisui"),
        ]
