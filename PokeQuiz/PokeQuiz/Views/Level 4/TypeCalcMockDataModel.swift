...
struct Level4MockDataModel: View {
    ...
    var pokemonTypes = ["Flying", "Fire"]
    @State private var weaknessesArr: [String] = []
    @State private var superWeaknesses: [String] = []
    @State private var resistanceArr: [String] = []
    @State private var superResistance: [String] = []
...
//compactMapValues??
    ...
    var body: some View {
        VStack {
            Button("Test") {
                updateCurrentPokemonDictionaryStrengthWeaknesses(typeArr: pokemonTypes)
                calculateStrengthsWeaknesses(typesDictionary: currentTypes)
            }
            Button("Print") {
                print("\(currentTypes["Bug"] as Optional)")
                print("Weakness Array: \(weaknessesArr)")
                print("Super Weakness: \(superWeaknesses)")
                print("Resistance: \(resistanceArr)")
                print("Super Resistance: \(superResistance)")
            }
            List {
                ForEach(currentTypes.sorted(by: <), id: \.key) { key, value in
